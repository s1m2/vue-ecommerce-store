      ...
      <div class="grid lg:grid-cols-[1fr_4fr] gap-10">
        ...
        <div v-else>
          <div class="flex justify-between">
            <button class="flex gap-3 place-items-center mb-6 border py-2 px-4 rounded-3xl" v-if="selectedCategory">{{ selectedCategory }} <IconClose class="pointer" height="18" width="18" @click="resetCategory()"/></button>
